...
title: Don't Bite Me — Herbal Strategies for Bug Season
description: A live virtual workshop from The Rooted Wisdom. Herbal protection for body, home, and pet through the long bug season. June 17th, 6PM PT.
eventDate: "2026-06-17"
eventDateDisplay: "June 17, 2026"
...
<header class="hero">
  ...
  <h1>
    <span class="line-eyebrow">Don't</span>
    <em class="line-title">Bite Me</em>
  </h1>
  <p class="hero-subtitle">Herbal Strategies for the Long Bug Season</p>
  <div class="hero-meta">
    <div class="meta-pill">
    ...
    <div class="meta-pill">
      ...
      <span class="meta-pill-value">June 17th</span>
    </div>
    <div class="meta-dot"></div>
    <div class="meta-pill">
...
<div class="ticker-wrap" aria-hidden="true">
  <div class="ticker-track">
    <span class="ticker-item">Mosquitoes<span class="dot">✦</span></span>
    <span class="ticker-item">Ticks<span class="dot">✦</span></span>
    <span class="ticker-item">Chiggers<span class="dot">✦</span></span>
    <span class="ticker-item">Fleas<span class="dot">✦</span></span>
    <span class="ticker-item">Herbal Repellents<span class="dot">✦</span></span>
    <span class="ticker-item">After-Bite Care<span class="dot">✦</span></span>
    <span class="ticker-item">Home Protection<span class="dot">✦</span></span>
    <span class="ticker-item">Pet Safety<span class="dot">✦</span></span>
  ...
  <div class="workshop-container">
    ...
    <div class="pricing-grid">
      <div class="pricing-card">
        ...
        <a href="https://buy.stripe.com/28E3cvgKf9fGdjX9n70480h" class="ws-btn">Join Workshop — $20</a>
      </div>
      <div class="pricing-card is-vip">
        ...
        <a href="https://buy.stripe.com/fZu9AT51xeA07ZD42N0480i" class="ws-btn is-vip-btn">Join as VIP — $35</a>
      </div>
    </div>
  </div>
</section>
...
<div class="body-bridge">
  <div class="workshop-container-narrow" style="text-align: center;">
    ...
    <h2 class="ws-section-title" style="font-size: clamp(1.6rem, 4vw, 2.4rem); font-style: italic; margin-bottom: 1.5rem;">Mosquitoes are winning.<br>Let's change that.</h2>
    <p class="ws-body-text">Every summer we hand it over. To the spray that smells like a chemistry lab. To the candle that doesn't quite work. To the welts that last for days. To the dog scratching on the rug. To the mosquito buzzing in the bedroom at 2am.</p>
    <p class="ws-body-text" style="margin-top: 1.25rem;">There is a different way. Generations of practitioners across the diaspora have been working with plants to keep biting things at bay — on the body, in the home, with the animals we live with, across the whole season. This workshop is a working introduction to that practice.</p>
  </div>
</div>
...
<section class="curriculum-section">
  ...
  <div class="workshop-container">
    ...
    <h2 class="ws-section-title">One hour and forty-five minutes —<br>across <em>four domains.</em></h2>
    <p class="ws-body-text">We'll look at herbal strategies for each of the places bugs touch our lives. Expect real teaching, practical knowledge, and time to ask questions.</p>
    <div class="curriculum-list">
      <div class="curriculum-item">
        <span class="curriculum-num">01</span>
        <p class="curriculum-text"><strong>The Body</strong>Herbal strategies for keeping biting things off you in the first place — and for taking care of the bites that get through.</p>
      </div>
      <div class="curriculum-item">
        <span class="curriculum-num">02</span>
        <p class="curriculum-text"><strong>The Home</strong>How plants have been used at the threshold, the windowsill, and on the stove to keep bugs out of the spaces we live in.</p>
      </div>
      <div class="curriculum-item">
        <span class="curriculum-num">03</span>
        <p class="curriculum-text"><strong>The Pet</strong>Safe herbal approaches for the animals we share our homes with — including the safety considerations the internet often gets wrong.</p>
      </div>
      <div class="curriculum-item">
        <span class="curriculum-num">04</span>
        <p class="curriculum-text"><strong>The Long View</strong>What it looks like to work with the body and the land across a whole season — the practice that holds the other three together.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="vip-section">
  ...
  <div class="workshop-container">
    <p class="vip-label">The VIP Experience</p>
    <h2 class="vip-title">More than <em>a workshop.</em></h2>
    <p class="vip-body">For an additional $15, the VIP ticket extends the workshop into 30 days inside the Herb-Curious Community — where the practice continues with monthly classes, a growing library, and a community of people doing this work alongside you.</p>
    <div class="vip-perks">
      <div class="vip-perk">
        <p class="vip-perk-icon">✦</p>
        <p class="vip-perk-title">30 Days in Herb-Curious</p>
        <p class="vip-perk-body">Full access to the Rooted Wisdom community — conversations, prompts, and live gatherings.</p>
      </div>
      <div class="vip-perk">
        <p class="vip-perk-icon">✦</p>
        <p class="vip-perk-title">Workshop Archive</p>
        <p class="vip-perk-body">Every past workshop recording, including foundational classes on tincturing, infused oils, and more.</p>
      </div>
      <div class="vip-perk">
        <p class="vip-perk-icon">✦</p>
        <p class="vip-perk-title">Materia Medica Library</p>
        <p class="vip-perk-body">Deepening references, plant monographs, and resources for ongoing study.</p>
      </div>
      <div class="vip-perk">
        <p class="vip-perk-icon">✦</p>
        <p class="vip-perk-title">Free Future Workshops</p>
        <p class="vip-perk-body">Membership-included access to upcoming Rooted Wisdom workshops during your 30 days.</p>
      </div>
    </div>
    <a href="https://buy.stripe.com/fZu9AT51xeA07ZD42N0480i" class="btn-vip">Join as VIP — $35</a>
    <p class="vip-fine">Upgrade anytime — the door stays open.</p>
  </div>
</section>
